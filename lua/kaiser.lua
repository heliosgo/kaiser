...
local syntax = {
  ...
  Include = { fg = z.cred },
  Define = { fg = z.violet },
  Conditional = { fg = z.dred },
  Repeat = { fg = z.dred },
  Keyword = { fg = z.dred },
  Typedef = { fg = z.corange },
  Exception = { fg = z.red },
  Statement = { fg = z.red },
  Error = { fg = z.red },
...
local plugin_syntax = {
  ["@function"] = { fg = z.kblue2 },
  ["@method"] = { fg = z.kblue2 },
  -- ["@keyword.function"] = { fg = z.cgreen6 },
  ["@keyword.function"] = { fg = z.dred },
  ["@property"] = { fg = z.dryellow },
  ["@type"] = { fg = z.ryellow },
  ["@variable"] = { fg = z.cwhite },
  ["@punctuation.bracket"] = { fg = z.cgreen4 },
  ...
  NvimTreeFolderName = { fg = z.xinlan },
